...
urlpatterns = [
    ...
    # API endpoints
    path('api/fire-reports/', api_views.firereport_list_create, name='api_firereport_list_create'),
    path('api/fire-reports/<int:pk>/', api_views.firereport_detail, name='api_firereport_detail'),
]